...
CREATE TABLE IF NOT EXISTS public.order (
    ...
    order_status order_status_type NOT NULL DEFAULT 'Submitted'::order_status_type,
    CONSTRAINT purchase_pkey PRIMARY KEY (purchase_id)
);
-- Create relationship between 'inventory' and 'order' tables
...
-- Create relationship between 'account' and 'order' tables
ALTER TABLE IF EXISTS public.order
